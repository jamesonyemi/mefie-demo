@php
    $key =  0;
    $status = config("app.ongoing_status_text"); 
@endphp

@if (empty($get_client_ongoing_project))
    @include('partials.check_for_empty_value', [ $status ])
  @else
  <div class="my-4 row animate__animated animate__slideInRight">
      ...
      <div class="col-lg-8 col-md-6 col-sm-12">
          <div class="card top-rated-product-box mb-30">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="card-body">
     <ul>
            @foreach ($get_client_ongoing_project as  $item)
        ...
        <a href="#" class="view-link d-inline-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Details">
