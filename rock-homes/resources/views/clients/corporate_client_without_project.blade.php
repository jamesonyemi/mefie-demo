                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style='text-align:left'>
                                                <a href=" {{ route('view-corporate-client', $encryptId)}}" class="mr-2 nav-link">
                                                    {{ $item->company_name }}
                                                </a>
                                             </td>
                                            <td style='text-align:left'>
                                            ...
                                            <td>{{ $item->mobile }}</td>
                                            <td>
                                                <a href=" {{ route('view-corporate-client', $encryptId)}}" class="mr-2 d-inline-block text-success">
                                                    <i class="bx bxs-analyse bx-sm"></i>
                                                </a>
                                                <a href="{{ route('edit-corporate-client', $encryptId) }}" class="mr-2 d-inline-block text-success">
