                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="" class="table table-bordered dt-responsive nowrap payment-per-view w-100" 
                                                style="border-collapse: collapse; border-spacing: 0;">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Stage</th>
                                                <th>Amount Received @include("partials.user_currency_symbol")</th>
                                                <th>Project</th>
                                                <th>Owner</th>
                                                <th>Action</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style='text-align:left'>
                                                    <a href="{{ $redirect_url }}" class="nav-link mr-2" >
                                                        {{ ucfirst( number_format($stage->amt_received, 2 )) }}
                                                    </a>
                                                    </td>
                                                <td class="invisible">{{ $stage->pid }}</td>
                                                <td class="invisible">{{ $stage->clientid }}</td>
                                                <td>
                                                <a href="
                                                {{ $redirect_url }"
...
<script>
    document.querySelector("#pid").addEventListener( "change", () => {
        document.querySelector("#currency-symbol").classList.remove("invisible");
    });
</script>
