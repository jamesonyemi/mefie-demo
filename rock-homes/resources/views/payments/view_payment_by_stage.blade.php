                    ...
                    <div class="bd-example mt-2 mb-2">
                      <div class="d-flex flex-wrap bd-highlight">
                        <div class="mr-auto p-2 bd-highlight">
                            <label>
                              <span class="d-flex align-items-center badge badge-light bx-xs">Client Name</span>
                                  <span id="client-name" class="text-info h4 text-capitalize">{{ $total_amount_received->client_name }}</span>
                             </label>
                        </div>
                        <div class="mr-auto p-2 bd-highlight">
                            <label>
                              <span class="d-flex align-items-center badge badge-light bx-xs">Project Name</span>
                                  <span id="client-name" class="text-info h4 text-capitalize">{{ $total_amount_received->project_name }}</span>
                             </label>
                        </div>
                        <div class="p-2 bd-highlight">
                           <label class="">
                                  <span class="d-flex align-items-center badge badge-warning bx-xs">Total cost for 
                                        <span class="badge badge-secondary bx-xs ml-1">
                                            {{ ucwords($total_amount_received->phase) }} 
                                        </span>
                                  </span>
                                  
                                    <span id="total-cost" class="text-info h4">
                                       {{ config("app.set_default_currency") }}
                                    ...
                                    <table id="" class="table table-bordered dt-responsive nowrap payment-per-view" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Date</th>
                                                <th>Amount Received ({{ config("app.set_default_currency") }})</th>
                                            </tr>
                                        </thead>
                                        <tbody>
