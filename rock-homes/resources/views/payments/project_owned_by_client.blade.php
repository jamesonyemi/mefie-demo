                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">
                                    ...
                                    <span class="text-capitalize">{{ $client_info->client_name }}</span>  
                                </h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="" class="table table-bordered dt-responsive nowrap stage" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="mb-5"></td>
                                                <td  class="mb-5">
                                                    <a href=" {{ route('payments.show',  $encryptId)}}" class="d-inline-block nav-link ">
                                                    {{ $project->project_name }}
                                                     </a>
                                                </td>
                                                <td>
                                                    <i class=""> GH₵</i>
                                                    {{ number_format($project->estimated_budget, 2)  }}</td>    
                                                <td>
