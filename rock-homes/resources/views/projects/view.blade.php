            ...
            <div class="card-body">
                @foreach ($projectById as $project)
                    ...
                    <div class="form-row mb-5">
                        <div class="form-group col-md-1"></div>
                        <div class="form-group col-md-10 col-lg-10 col-m-10">
                            <label for="validate_othername">Project Description</label>
                        <textarea class="form-control list-group-item h-100" name="description" id="description"  disabled value="{{ old('description', $project->description) }}">
