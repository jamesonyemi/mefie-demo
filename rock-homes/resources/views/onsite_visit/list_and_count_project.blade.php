                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <blockquote class="blockquote">
                          <p class="mb-0 h3"> Client Projects </p>
                          <small>
                              <footer class="blockquote-footer">
                                  showing projects counts belonging to a client 
                              </footer>
                          </small>
                        </blockquote>
                            ...
                            <table id="" class="table table-bordered dt-responsive table-hover  stage w-100" >
                                <thead>
                                    <tr>
                                        ...
                                        <th>owner</th>
                                        <th >
                                            <p class="d-none d-sm-block hidden-sm mr-sm-5">
                                            no. of projects  
                                            </p>
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    @foreach ($count_projects as $client_info)
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href=" {{ route('client-project-counter', $encryptId ) }}" class="d-inline-block text-success mr-2" >
                                        ...
                                        <td class="">
                                            <div class="btn-group">
                                              <button type="button" class="btn btn-info btn-warning dropdown-toggle w-100" 
                                                ...
                                                <span class="badge badge-light">{{ $client_info->count_project }}</span>
                                                  ...
                                                  <div class="dropdown-menu">
                                                    @foreach($get_projects as $key => $value)
                                                      @if($client_info->clientid === $value->clientid)
