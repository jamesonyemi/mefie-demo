                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">
                                    <div>
                                        <i class="badge badge-secondary bx-md ">Project Owner</i> 
                                    </div>
                                    <small>{{ ucwords($client_info->client_name) }}  </small>
                                </h4>
                                    ...
                                    <table id="" class="table table-bordered dt-responsive nowrap stage" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                 ...
                                                 $encryptClientd = Crypt::encrypt($project->clientid); 
                                                 $encryptPid = Crypt::encrypt($project->pid); 
                                                 
                                             ?>
                                            <tr>
                                                <td class="mb-5"></td>
                                                <td  class="mb-5">
                                                    <a href=" {{ route('all-project-visited',  $encryptPid)}}" class="d-inline-block nav-link ">
                                                    {{ $project->title }}
                                                     </a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href=" {{ route('all-project-visited', $encryptPid)}}" class="d-inline-block text-success mr-2 bx-sm" >
