            ...
            <div class="container">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <div class="mt-3">
                            <a href="#price" class="btn btn-primary"><i class="mdi mdi-account"></i> Sign Up</a>
                        </div>
            ...
            <div class="container" >
                ...
                <div class="row align-items-center">
                    <div class="pt-2 mt-4 col-md-4 col-12">
                        <div id="base-pr" class="py-5 text-center border-0 rounded card pricing-rates bg-light">
                            <div class="card-body">
                                <h2 class="mb-4 title text-uppercase">Basic</h2>
                                ...
                                <a href="{{ route('sign-up', Crypt::encrypt($subscription_type['basic']) ) }}"  class="mt-5 mb-n4 rounded-5 btn btn-primary w-100">Choose a Plan</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="pt-2 mt-4 col-md-4 col-12">
                        <div id="stan-pr" class="py-5 text-center border border-0 rounded card pricing-rates starter-plan bg-light">
                            <div class="card-body">
                                ...
                                <a href="{{ route('sign-up', Crypt::encrypt($subscription_type['standard'])) }}"   class="mt-5 mb-n4 rounded-5 btn btn-primary w-100">Choose a Plan</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="pt-2 mt-4 col-md-4 col-12"  >
                        <div id="prime-pr" class="py-5 text-center border-0 rounded card pricing-rates bg-light">
                            <div class="card-body">
                                ...
                                <a href="{{ route('sign-up', Crypt::encrypt($subscription_type['professional'])) }}"   class="mt-5 mb-n4 rounded-5 btn btn-primary w-100">Choose a Plan</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
