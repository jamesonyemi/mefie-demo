                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">
                                    <div>
                                        <i class="badge badge-secondary rounded-pill text-capitalize h4 text-white" >Project Owner</i> 
                                    </div>
                                    <p class="text-capitalize h4">{{ $client_info->client_name }}</p>  
                                </h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="" class="table table-bordered dt-responsive nowrap stage" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="mb-5"></td>
                                                <td  class="mb-5">
                                                    <a href=" {{ route('project-docs.show',  $encryptId)}}" class="d-inline-block nav-link ">
                                                    {{ $project->title }}
                                                     </a>
                                                </td>
                                                <td>
