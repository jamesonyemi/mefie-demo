        ...
        <div>
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="card-title">Client Project Payment BreakDown </h5>
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <table id="" class="table table-bordered table-responsive dt-responsive w-100 my-payment" >
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>project</th>
                                                <th>owner</th>
                                                <th>budget<i class="font-weight-bolder">(GH₵)</i></th>
                                                <th>active</th>
                                                <th>created</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="col-1 text-center font-rem"></td>
                                                <td >
                                                ...
                                                <td >
                                                    <a  href="{{ route('my-payments.show', $encryptId ) }}" class="nav-link font-rem text-primary text-capitalize" 
                                                        id="del-modal" >
                                                        {{ $payment->client_name }}
                                                    </a>
                                                </td>
                                                <td class="text-capitalize text-center font-rem" >{{ number_format($payment->estimated_budget, 2) }}</td>
                                                <td class="text-lowercase text-center font-rem">{{  strtoupper($payment->active) }}</td>
                                                <td class="text-capitalize text-center font-rem">{{ date('l, jS F, Y', strtotime($payment->created_at))  }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
