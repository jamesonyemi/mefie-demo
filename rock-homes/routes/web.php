...
Route::group(['prefix' => 'onboarding'], function () {
    ...
    Route::post('/receive-hook/{ref?}', 'ReceiveWebHookEventController@receiveWebHookEvent')->name('receive-hook');
    ...
    Route::get('/sign-up/customers/{em-id?}/{name?}', 'ClientOnboarding@customerUserDataIntersection')->name("sign-up-customers");
    Route::get('/sign-up/{subscription_type?}', 'ClientOnboarding@create')->name('sign-up');
    Route::any('/store-customer', 'ClientOnboarding@storeCustomerInfo')->name('store-customer');
    Route::any('/customer-onboarding', 'ClientOnboarding@onboardingMessage')->name('customer-onboarding');
    ...
    Route::group( ['middleware' => ['auth', 'admin'], 'prefix' => 'admin-portal'],  function() {
        ...
        Route::get('/home', 'HomeController@index')->name('home');
            ...
            Route::middleware([CheckUserRole::class])->group(function () {
                ...
                Route::any('/fud', 'ProfileController@fetchUserData')->name('fud');
                ...
                Route::any('/subscription-page', 'ClientController@showSubscription')->name('pricing-page');
                Route::any('/upgrade-subscription-plan/{pricing_id?}', 'ClientController@updateCustomerSubscriptionPlan')->name('update_subscription-plan');
                ...
                Route::any('/show-users', 'VerifiedUserController@showUsers')->name('show-all-users');
        ...
        Route::any('/onsite-visit/client-project-counter/{cid}','OnsiteVisitController@listAndCountProject')->name('client-project-counter');
        Route::any('/onsite-visit/create/{id}','OnsiteVisitController@clientToProject');
        Route::any('/onsite-visit/{pid}/{vid}/edit','OnsiteVisitController@edit')->name('onsite-visit.edit');
        Route::any('/onsite-visit/project-visited/{pid}/{cid}','OnsiteVisitController@allProjectsByClient')->name('project-visited');
        Route::any('/onsite-visit/all-visits/{id}','OnsiteVisitController@allVisits')->name('all-project-visited');
        Route::any('/onsite-visit/remove-unlink-image/{id}/{img_path}','OnsiteVisitController@deleteProjectImage')->name('remove-unlink-project_image');
        ...
        Route::resource('payment-mode', 'PaymentModeController');
                Route::resource('payments', 'PaymentController')->middleware('check-subscription-plan:standard,professional');
