...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        $client_payment_by_stage   =   DB::table("vw_track_client_payment_by_stage")->select("*")
                                                    ->where("created_by_tenant_id", Auth::user()->tenant_id)->groupBy("pid")->get();


       return view('payments.index', compact('client_payment_by_stage', 'regions', 'users', 'project_status', 'all_clients', 'clientWithProjects', 'get_project'));
    ...
    public function paymentPerStageOfCompletion($incoming_project_id, $incoming_client_id, $incoming_project_phase_id) 
    {
        ...
        $payment_per_stage  =  DB::table('vw_track_client_payment')->latest('paymentdate')
        ...
        $total_amount_received =  DB::table("vw_track_client_payment")
                                    ->select(DB::raw('sum(amt_received) as total_cost, client_name, phase, project_name'))
